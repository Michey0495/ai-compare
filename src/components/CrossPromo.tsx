...
const services = [
  ...
  { name: "AI議事録", desc: "AIが会議メモから議事録生成", url: "https://ai-minutes.ezoai.jp", accent: "text-teal-400" },
  { name: "AIプロフカード", desc: "AIがプロフカードを自動生成", url: "https://ai-profilecard.ezoai.jp", accent: "text-sky-400" },
  { name: "AIなんでも比較", desc: "AIが2つのものを徹底比較", url: "https://ai-compare.ezoai.jp", accent: "text-rose-400" },
];
